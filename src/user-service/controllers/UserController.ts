...
import { User } from "../../attestation-service/entity/User";
import Logger from "../../lib/logger";
import { v2 as cloudinary } from 'cloudinary';
import { faker } from '@faker-js/faker';
import { ethers } from "ethers";
import { isAuthenticated, isValidAddress } from "../../Oauth-service/middlewears/authMiddleware";
import { calculateSocialScore, memoryStoreProfile, SOCIAL_SCORE } from "../../utils/global";
import { app } from "../..";
...
import { ClientApp } from "../../client-service/entity/ClientApp";
...
//body => address
userRouter.get('/capacity', isAuthenticated, isValidAddress, async (req, res) => {
    try {
        const id = req?.user?.id;
        const existingUser = await userRepository.findOne({
            where: {
