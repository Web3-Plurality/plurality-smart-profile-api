...
smartProfileRouter.put("/", isAuthenticated, [
    ...
    try {
        ...
        // new profile creation
            ...
            if (!profileMapping) {
                ...
                newProfile.updateScoreValue(SCORE_TYPES.SOCIAL_SCORE, earlyUser?.username ? 1000 : Number(process.env.DEFAULT_SOCIAL_SCORE))
