import { EAS, MerkleValue, Offchain, OffchainAttestationVersion, OffchainConfig, PrivateData, SchemaEncoder } from "@ethereum-attestation-service/eas-sdk";
...
export async function OffchainAttestations(user: MerkleValue[], address: string) {
    try {
        ...
        const provider = ethers.getDefaultProvider(
            "https://eth-sepolia.g.alchemy.com/v2/-Wu369VGLVlWnEt3VXbHLUoJxzkJzwi7"
        );
